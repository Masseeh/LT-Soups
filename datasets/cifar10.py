...
class IMBALANCECIFAR10(torchvision.datasets.CIFAR10):
    ...
    def get_img_num_per_cls(self, cls_num, imb_factor):
        ...
        if imb_factor == -1:
            img_num_per_cls = [int(img_max), ] + [1, ] * (cls_num - 1)
...
class CIFAR10_IR1000(IMBALANCECIFAR10):
    def __init__(self, root, split="train", transform=None, cfg=None):
        super().__init__(root, imb_factor=0.001, split=split, transform=transform)

class CIFAR10_IR(IMBALANCECIFAR10):
    def __init__(self, root, split="train", transform=None, cfg=None):
        super().__init__(root, imb_factor=-1, split=split, transform=transform)
