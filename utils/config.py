...
_C.val_only = False  # load model and validate
...
_C.use_proj = False         # use projection layer for image encoder
_C.balanced_sampling = False# balanced sampling for lora vectors
_C.eval_on_val = True       # evaluate on validation set
_C.eval_freq = 10
_C.exp_scale = 1.0          # exponent scale for generalized reweighting
_C.save_model = True
_C.skip_test = True
_C.save_results = True
_C.adam = False
_C.scheduler = 'cosine'
_C.sub_sample_seed = 0
_C.subsample = False
_C.ema_decay = 0.1
_C.round_num = 0
_C.sample_decay = 0.0
...
_C.meta_bsz = 2
_C.balance_factor = 1
_C.inner_selection = "mean"
_C.mixup = 0.0
_C.ls = 0.0
_C.fraction_bf = False
_C.mini_cls = 200
_C.save_head_class_mean = True
_C.warmup = True
...
_C.merge_lm = 0.7
_C.factors = [5, 6, 7]
_C.save_every_factors = True
_C.random_init = False

## Per dataset
_C.many_threshold = 100
_C.few_threshold = 20
_C.cls_split_f = 80